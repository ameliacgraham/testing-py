...
def is_mel(name, email):
    ...
    >>> is_mel('Mel Melitpolski', 'mel@ubem')
    True

    >>> is_mel('Melpolski', 'mel@ubermelon.com')
    True

    >>> is_mel('Mlski', 'mel@un.com')
    False
...
def most_and_least_common_type(treats):
    ...
    Test for tie. The code currently returns arbitrarily. FIX NEEDED.
